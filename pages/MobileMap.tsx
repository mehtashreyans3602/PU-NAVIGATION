...
import PlaceCard from "@/pages/atoms/PlaceCard";
...
const MobileMap: React.FC = () => {
    ...
    return (
        <section className='w-full h-auto flex flex-col gap-6 overflow-hidden'>
            <section className='absolute h-auto scroll-smooth backdrop-blur-3xl w-full flex gap-x-10 overflow-x-scroll z-20 mt-5'>
